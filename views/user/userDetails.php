        ...
        <div class="col-sm-9">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="home">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <?= $form->field($model->userAddress, 'address')->textInput(['autofocus' => true]) ?>
                        </div>
                    </div>
                    <div class="form-group">

                        <div class="col-xs-6">
                            <?= $form->field($model->userAddress, 'city')->textInput(['autofocus' => true]) ?>
                        </div>
                    </div>
                    <div class="form-group">

                        <div class="col-xs-6">
                            <?= $form->field($model->userAddress, 'country')->textInput(['autofocus' => true]) ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <br>
                            <?= Html::submitButton('Save' . '<i class="fa fa-fw fa-user"></i>', ['class' => 'btn btn-lg btn-success', 'name' => 'login-button']) ?>
