...
class Blog extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['created_at', 'updated_at', 'created_by', 'updated_by', 'views'], 'integer'],
    ...
    {
        return $this->hasMany(Likes::className(), ['blog_id' => 'id']);
    }

    public function EventBeforeView($blog)
    {
        if ($blog->views == null) {
            $blog->views = 1;
        } else {
